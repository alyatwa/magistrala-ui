...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center text-gray-950 rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
    ...
    <div className="flex flex-row py-24 gap-6">
      <div className="flex flex-col justify-between gap-1">
        ...
        <p className="text-base font-light text-gray-800">
          WebSocket, MQTT, Modbus, LoRaWAN, OPC UA - seamless integration with
          any industrial protocol
        </p>
      </div>
      <div
...
const Icons = {
  ...
  googleDrive: () => <IconBuildingWindTurbine />,
  whatsapp: () => <IconSignal5g />,
  googleDocs: () => <IconTemperatureSun />,
  zapier: () => <IconAntennaBars5 />,
  messenger: () => <IconRouter />,
};
  ...
  return (
    ...
    >
      <AnimatedShinyText className="inline-flex bg-white items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300  ">
        ...
        <span className="text-black/95 leading-1 ml-1">
          Wide variety channels
        </span>
